...
- Lista de solicitudes: en columna "Modelo" muestra primero `Templates usados: ...` (si existe en `AccessRequest.notes`); si no, muestra resumen por empresa solo para solicitudes por usuario modelo
